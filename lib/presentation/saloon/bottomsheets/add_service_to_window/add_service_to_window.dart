...
class AddServiceToWindowBottomSheet extends StatelessWidget {
  const AddServiceToWindowBottomSheet({super.key, required this.controller});
  final AddServiceToWindowController controller;
  @override
...
class _BodyViewState extends State<BodyView> {
  @override
  Widget build(BuildContext context) {
    final controller = Provider.of<AddServiceToWindowController>(context);
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          ...controller.mastersWindowControllerList.map(
            (masterStore) => MasterWindowWidget(
              store: masterStore,
            ),
          ),
        ],
