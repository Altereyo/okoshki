...
class EditCommentBottomSheet extends StatelessWidget {
  const EditCommentBottomSheet({super.key, required this.controller});
  final EditCommentController controller;
                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            initialValue: controller.textComment,
                            autofocus: true,
                        ...
                        ButtonCustomer.large(
                          title: 'Сохранить',
                          onPressed: controller.isEnabledButtonEditComment
                              ? () async {
                                  final isResult =
                                  ...
                                  if (context.mounted) {
                                    showAdaptiveDialog(
                                      context: context,
                                      builder: (context) {
                                        return const DialogApp.updateComment();
                                      },
                                    );
                                  }
                                }
